...
using AuthServiceRestaurante.Application.Exceptions;
using AuthServiceRestaurante.Application.Extensions;
using AuthServiceRestaurante.Application.Validators;
using AuthServiceRestaurante.Domain.Constants;
using AuthServiceRestaurante.Domain.Entities;
using AuthServiceRestaurante.Domain.Interfaces;
using AuthServiceRestaurante.Domain.Enums;
using Microsoft.Extensions.Configuration;
using Microsoft.Extensions.Logging;
using AuthServiceRestaurante.Application.DTOs.Email;

namespace AuthServiceRestaurante.Application.Services;
