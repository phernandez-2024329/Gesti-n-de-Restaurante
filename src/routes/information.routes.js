...
import { validateInformation } from '../../middlewares/auth-validators.js';
import { Roles } from '../constants/roles.js';

const router = Router();

// Crear information (ADMIN o GERENTE)
router.post('/', validateJWT, validateRole(Roles.ADMIN, Roles.GERENTE), validateInformation, createInformation);
